        ...
        public:
            ...
            bool make(const string& text, size_t topN, vector<pair<uint64_t, double> >& res) const
            {
                ...
                for (int i = 0; i < wordweights.size(); i++)
                    cout << wordweights[i].first << "  " << wordweights[i].second << endl;
            ...
            static int get_distance(uint64_t lhs, uint64_t rhs)
            {
                int cnt = 0;
                lhs ^= rhs;
                while(lhs)
            ...
            {
                cout << "bits 1 \t " << lhs << endl;
                cout << "bits 2 \t " << rhs << endl;
